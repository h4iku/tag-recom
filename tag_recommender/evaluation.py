...
def prepare_estimate_date(train_set):
    ...
    tags_order, multilabel_scores = multilabel_classification.multilabel_clf(train_set, test_set)
...
def recommend(param_estimate_data):
    ...
    results = evaluate(params, tags_order, test_set, multilabel_scores, similarity_scores)
